...
function TikTokIcon({ size = 17 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16.6 5.82A4.67 4.67 0 0 1 13.5 2h-3.1v12.45a2.69 2.69 0 1 1-1.86-2.56V8.74a5.8 5.8 0 1 0 5.97 5.79V8.22a7.74 7.74 0 0 0 4.52 1.45V6.59a4.7 4.7 0 0 1-2.43-.77Z" /></svg>;
}
  ...
  return <div className="site-shell grain" id="home">
    ...
    <main>
      ...
      <section className="intro section-pad" id="about">
        <div className="container-wide intro-grid"><div className="reveal"><span className="eyebrow">About IGAF</span><h2>We put better<br />tools in the hands<br />of <em>good work.</em></h2></div><div className="intro-body reveal delay-1"><p>Ibrahimawa Global and Farm Ltd is a Nigerian agricultural company providing farm machinery, agricultural equipment, and farming solutions to farmers, agricultural businesses, cooperatives, and institutions. The company offers reliable equipment and services designed to support modern farming, improve productivity, and make agricultural operations more efficient. Ibrahimawa Global and Farm Ltd serves customers in Nigeria and is committed to providing quality agricultural solutions, professional service, and dependable customer support.</p><p>We believe modernisation should be practical. It should meet the farmer where they are, answer a real constraint and make the next season meaningfully better.</p><div className="signature"><span className="signature-line" /><span className="mono">A hands-on partner, from field to factory</span></div></div></div>
        <div className="container-wide stat-strip reveal delay-2"><div className="stat"><strong>10</strong><span>Agricultural machinery dealers in Abuja</span></div><div className="stat"><strong>360°</strong><span>Farm equipment suppliers Nasarawa state</span></div><div className="stat"><strong>Naija</strong><span>Tractor dealers Keffi &amp; Agric machines Auta Balefi</span></div></div>
      </section>
      <section className="dark-section section-pad" id="products"><div className="container-wide"><div className="section-heading reveal"><div><span className="eyebrow" style={{ color: 'hsl(var(--secondary))' }}>The equipment</span><h2>Machines that<br /><em>pull their weight.</em></h2></div><p>Ibrahimawa Global and Farm Ltd → Farm Machinery → Tractors → Irrigation Equipment → Processing Equipment → Agricultural Services</p></div><div className="products-grid">{products.map((product, index) => <ProductCard key={product.name} product={product} index={index} onOpen={openEnquiry} />)}</div></div></section>
      ...
      <section className="contact section-pad" id="contact"><div className="container-wide contact-grid"><div className="reveal"><span className="eyebrow" style={{ color: 'hsl(var(--secondary))' }}>Contact IGAF</span><h2>Tell us what<br /><em>you’re building.</em></h2><p className="contact-intro">Whether you are preparing your first field, expanding a processing line or looking for a better way to harvest, our team is ready to hear the full picture.</p><div className="contact-details"><a className="contact-detail contact-social" href="tel:+2347047197737" aria-label="Call IGAF on +234 704 719 7737"><Phone size={17} /><div><b>Call the team</b><span>+234 704 719 7737</span></div></a><a className="contact-detail contact-social" href="tel:+2348100809016" aria-label="Call IGAF on +234 810 080 9016"><Phone size={17} /><div><b>Alternate call line</b><span>+234 810 080 9016</span></div></a><div className="contact-detail"><Mail size={17} /><div><b>Send an email</b><span>ibrahimawafarms@gmail.com</span></div></div><a className="contact-detail contact-social" href="https://www.tiktok.com/@agricmachins" target="_blank" rel="noreferrer" aria-label="Follow IGAF on TikTok" data-testid="link-tiktok"><TikTokIcon /><div><b>Follow us on TikTok</b><span>@agricmachins</span></div></a><div className="contact-detail"><MapPin size={17} /><div><b>Keffi branch</b><span>Masallacin Idi, Keffi, Nasarawa State</span></div></div><div className="contact-detail"><MapPin size={17} /><div><b>Second branch location</b><span>Abuja Road, Auta Balefi Beans Market</span></div></div><div className="contact-detail"><Clock3 size={17} /><div><b>Office hours</b><span>Every day, 7:00am–8:00pm WAT</span></div></div></div></div><div className="contact-form reveal delay-1"><ContactForm /></div></div><div className="container-wide map-card reveal"><div className="map-terrain" aria-hidden="true"><span className="map-route route-one" /><span className="map-route route-two" /><span className="map-place">IGAF · Keffi, Nasarawa</span><span className="map-coordinate">8.830252° N &nbsp; 7.878581° E</span></div><a className="map-pin" href="https://maps.app.goo.gl/HQAMXdP8y18sVP3h9" target="_blank" rel="noreferrer" aria-label="Open IGAF location in Google Maps" data-testid="link-map-pin"><MapPin size={28} fill="currentColor" /></a><a className="map-label" href="https://maps.app.goo.gl/HQAMXdP8y18sVP3h9" target="_blank" rel="noreferrer" data-testid="link-map-location"><MapPin size={15} />View our precise location on Google Maps</a></div></section>
    </main>
